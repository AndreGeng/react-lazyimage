...
class LazyImage extends Component {
  ...
  render() {
    const { targetSrc, defaultSrc, className, height } = this.props;
    ...
    return (
        <CSSTransitionGroup
          ...
          style={style}
        >
          {!visible ? <img src={defaultSrc} alt='default icon' className='lazyimage-img' /> : null}
          {visible ? <img src={targetSrc} alt='icon' className='lazyimage-img' /> : null}
        </CSSTransitionGroup>
    );
  }
}
